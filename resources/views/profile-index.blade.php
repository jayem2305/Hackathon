            ...
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <div class="list">
                    <a onclick="loadContent('preload/personalInfo.html')"
                      >Personal Information</a
                    ><br />
                    <a onclick="loadContent('preload/educationBackground.html')"
                      >Education Background</a
                    ><br />
                    <a onclick="loadContent('preload/workExperience.html')"
                      >Work Experience</a
                    ><br />
                    <a
                      onclick="loadContent('preload/professionalLicenses.html')"
